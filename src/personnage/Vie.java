...
public class Vie {
	...
	/**
	 * Met la vie a la valeur donn̩ en parametre
	 * @param value
	 */
	...
	/**
	 * Controle si le joueur n'a pas trop de vie ou s'il n'est pas mort. Ajuste la vie de l'entit̩ si celle ci depasse le maximum
